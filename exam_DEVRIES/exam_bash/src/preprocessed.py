...
raw_data_path = f"~/exam_DEVRIES/exam_bash/exam_Bash_MLOps/data/raw/sales_data.csv"
processed_data_path = f'~/exam_DEVRIES/exam_bash/exam_Bash_MLOps/data/processed/sales_processed_{YYYYMMDD_HHMM}.csv'
